...
%                           and pink noise
%           is_pink     =   1 for purturbing using pink-noise
%                           0 for purturbing using white-noise
%           perturball  =   1 for perturbing all channel with pink noise
%                           0 for perturbing only inactive channel
%	OUTPUTS
%           signal_noise        =   time series data generated from system.
%           pinknoise_cov       =   covariance matrix of pink noise               
