...
% Input: EEG data
% method: Reconstruct 75K source signal using sLORETA, WMNE, LCMV using brainstorm toolbox https://neuroimage.usc.edu/brainstorm/
% Output: Kernel matrix to convert EEG data to reconstructed source
% 
% Written by Parinthorn Manomaisaowapak, Piyapon Mahachaiwong
%
% Licenses
...
nVertices = 75000;
anatomy_loc = {...
        './input_data/nyhead_model/subjectimage_T1.mat',...           % Directory of MRI file (subjectimage_T1.mat)
        './input_data/nyhead_model/tess_scalp_150618_2140.mat',...    % Directory of Scalp
        './input_data/nyhead_model/tess_cortex_01.mat'                % Directory of Cortex
        };
    channel_loc = './input_data/nyhead_model/channel_61.mat';
...
for ii=1:100
    ...
    RawFiles = {...
        [inpath,'data',int2str(ii),'.mat'],... % EEG data
        channel_loc};
    AnatFiles = anatomy_loc;
    ...
    sFiles = bst_process('CallProcess', 'process_noisecov', sFiles, [], ...
        ...
        'identity',       1, ... % noise covariance structure (identity)
        'copycond',       0, ...
        'copysubj',       0, ...
        'copymatch',      0, ...
